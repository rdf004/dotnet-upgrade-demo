...
{
    /// <summary>
    /// Generates analytics and reports across
    ...
    public interface IReportService
    {
        ...
        Task<byte[]> GetSalesChartImageAsync(
            DateTime startDate,
            DateTime endDate);
    ...
    public class SalesReportDto
    {
        ...
        public IList<DailySalesDto> DailySales
        {
            get; set;
        }

        public IList<TopProductDto> TopProducts
        {
            get; set;
        }
    }
    ...
    public class UserActivityReportDto
    {
        ...
        public IList<UserActivityDto> Activities
        {
            get; set;
        }
    }
